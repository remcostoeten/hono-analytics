...
import type { TMetricsResponse, TAnalyticsConfig, TDateRange, THookResponse } from './types'
...
export function useAnalytics({ config, dateRange, pollingInterval }: TProps): THookResponse<TMetricsResponse> {
